...
public final class VideoPlayerPlugin: NSObject, FlutterPlugin, AVFoundationVideoPlayerApi {
  ...
  #if os(iOS)
    private var sharedPip: XingboSharedPip?
  #endif
  ...
  public static func register(with registrar: FlutterPluginRegistrar) {
    ...
    #if os(iOS)
      instance.sharedPip = XingboSharedPip(messenger: messenger) { [weak instance] id in
        return instance?.playersByIdentifier[id]?.player
      }
    #endif
  }
  ...
  private func configurePlayer(
    ...
    player.onDisposed = { [weak self] in
      ...
      #if os(iOS)
        strongSelf.sharedPip?.detach(playerId: playerId)
      #endif
